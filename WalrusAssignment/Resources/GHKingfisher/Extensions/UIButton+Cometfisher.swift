...
extension GHKingfisherWrapper where Base: UIButton {
    ...
    ///
    /// - Note:
    /// Internally, this method will use `GHKingfisherManager` to get the requested source, from either cache
    ...
    ///
    /// - Note:
    /// Internally, this method will use `GHKingfisherManager` to get the requested source
