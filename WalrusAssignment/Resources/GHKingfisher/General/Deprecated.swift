...
// MARK: - Deprecated
extension GHKingfisherWrapper where Base: CFCrossPlatformImage {
        ...
        onlyFirstFrame: Bool) -> CFCrossPlatformImage?
    {
        ...
        return GHKingfisherWrapper.image(data: data, options: options)
    }
...
// MARK: - Deprecated
extension GHKingfisherManager {
    /// Get an image with resource.
    /// If `.empty` is used as `options`, GHKingfisher will seek the image in memory and disk first.
    /// If not found, it will download the image at `resource.downloadURL` and cache it with `resource.cacheKey`.
    /// These default behaviors could be adjusted by passing different options. See `GHKingfisherOptions` for more.
    ///
    /// - Parameters:
    ///   - resource: Resource object contains information such as `cacheKey` and `downloadURL`.
    ///   - options: A dictionary could control some behaviors. See `GHKingfisherOptionsInfo` for more.
    ...
    @discardableResult
     func retrieveImage(with resource: Resource,
                              options: GHKingfisherOptionsInfo?,
...
extension ImageDownloader {
    ...
    @discardableResult
     func downloadImage(with url: URL,
                            ...
                            options: GHKingfisherOptionsInfo? = nil,
...
#if !os(watchOS)
// MARK: - Deprecated
extension GHKingfisherWrapper where Base: CFCrossPlatformImageView {
    @available(*, deprecated, message: "Use `Result` based callback instead.")
    @discardableResult
...
#if  !os(watchOS)
// MARK: - Deprecated
extension GHKingfisherWrapper where Base: UIButton {
    @available(*, deprecated, message: "Use `Result` based callback instead.")
    @discardableResult
     func setImage(
...
import WatchKit
// MARK: - Deprecated
extension GHKingfisherWrapper where Base: WKInterfaceImage {
    @available(*, deprecated, message: "Use `Result` based callback instead.")
    @discardableResult
...
#if os(macOS)
// MARK: - Deprecated
extension GHKingfisherWrapper where Base: NSButton {
    @discardableResult
    @available(*, deprecated, message: "Use `Result` based callback instead.")
     func setImage(with resource: Resource?,
                         placeholder: CFCrossPlatformImage? = nil,
...
extension ImageCache {
    ...
    open func retrieveImageInDiskCache(forKey key: String, options: GHKingfisherOptionsInfo? = nil) -> CFCrossPlatformImage? {
        let options = GHKingfisherParsedOptionsInfo(options ?? .empty)
...
// MARK: - Deprecated
extension Collection where Iterator.Element == GHKingfisherOptionsInfoItem {
    /// The queue of callbacks should happen from GHKingfisher.
    @available(*, deprecated, message: "Use `callbackQueue` instead.", renamed: "callbackQueue")
     var callbackDispatchQueue: DispatchQueue {
        return GHKingfisherParsedOptionsInfo(Array(self)).callbackQueue.queue
    }
}

/// Error domain of GHKingfisher
@available(*, deprecated, message: "Use `GHKingfisherError.domain` instead.", renamed: "GHKingfisherError.domain")
 let GHKingfisherErrorDomain = "com.onevcat.GHKingfisher.Error"

/// Key will be used in the `userInfo` of `.invalidStatusCode`
@available(*, unavailable,
message: "Use `.invalidHTTPStatusCode` or `isInvalidResponseStatusCode` of `GHKingfisherError` instead for the status code.")
 let GHKingfisherErrorStatusCodeKey = "statusCode"

// MARK: - Deprecated
extension Collection where Iterator.Element == GHKingfisherOptionsInfoItem {
    /// The target `ImageCache` which is used.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `targetCache` instead.")
     var targetCache: ImageCache? {
        return GHKingfisherParsedOptionsInfo(Array(self)).targetCache
    }

    /// The original `ImageCache` which is used.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `originalCache` instead.")
     var originalCache: ImageCache? {
        return GHKingfisherParsedOptionsInfo(Array(self)).originalCache
    }

    /// The `ImageDownloader` which is specified.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `downloader` instead.")
     var downloader: ImageDownloader? {
        return GHKingfisherParsedOptionsInfo(Array(self)).downloader
    }

    /// Member for animation transition when using UIImageView.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `transition` instead.")
     var transition: ImageTransition {
        return GHKingfisherParsedOptionsInfo(Array(self)).transition
    }

    /// A `Float` value set as the priority of image download task. The value for it should be
    /// between 0.0~1.0.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `downloadPriority` instead.")
     var downloadPriority: Float {
        return GHKingfisherParsedOptionsInfo(Array(self)).downloadPriority
    }

    /// Whether an image will be always downloaded again or not.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `forceRefresh` instead.")
     var forceRefresh: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).forceRefresh
    }

    /// Whether an image should be got only from memory cache or download.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `fromMemoryCacheOrRefresh` instead.")
     var fromMemoryCacheOrRefresh: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).fromMemoryCacheOrRefresh
    }

    /// Whether the transition should always happen or not.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `forceTransition` instead.")
     var forceTransition: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).forceTransition
    }

    /// Whether cache the image only in memory or not.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `cacheMemoryOnly` instead.")
     var cacheMemoryOnly: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).cacheMemoryOnly
    }

    /// Whether the caching operation will be waited or not.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `waitForCache` instead.")
     var waitForCache: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).waitForCache
    }

    /// Whether only load the images from cache or not.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `onlyFromCache` instead.")
     var onlyFromCache: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).onlyFromCache
    }

    /// Whether the image should be decoded in background or not.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `backgroundDecode` instead.")
     var backgroundDecode: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).backgroundDecode
    }

    /// Whether the image data should be all loaded at once if it is an animated image.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `preloadAllAnimationData` instead.")
     var preloadAllAnimationData: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).preloadAllAnimationData
    }

    /// The `CallbackQueue` on which completion handler should be invoked.
    /// If not set in the options, `.mainCurrentOrAsync` will be used.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `callbackQueue` instead.")
     var callbackQueue: CallbackQueue {
        return GHKingfisherParsedOptionsInfo(Array(self)).callbackQueue
    }

    /// The scale factor which should be used for the image.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `scaleFactor` instead.")
     var scaleFactor: CGFloat {
        return GHKingfisherParsedOptionsInfo(Array(self)).scaleFactor
    }

    /// The `ImageDownloadRequestModifier` will be used before sending a download request.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `requestModifier` instead.")
     var modifier: ImageDownloadRequestModifier? {
        return GHKingfisherParsedOptionsInfo(Array(self)).requestModifier
    }

    /// `ImageProcessor` for processing when the downloading finishes.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `processor` instead.")
     var processor: ImageProcessor {
        return GHKingfisherParsedOptionsInfo(Array(self)).processor
    }

    /// `ImageModifier` for modifying right before the image is displayed.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `imageModifier` instead.")
     var imageModifier: ImageModifier? {
        return GHKingfisherParsedOptionsInfo(Array(self)).imageModifier
    }

    /// `CacheSerializer` to convert image to data for storing in cache.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `cacheSerializer` instead.")
     var cacheSerializer: CacheSerializer {
        return GHKingfisherParsedOptionsInfo(Array(self)).cacheSerializer
    }

    /// Keep the existing image while setting another image to an image view.
    /// Or the placeholder will be used while downloading.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `keepCurrentImageWhileLoading` instead.")
     var keepCurrentImageWhileLoading: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).keepCurrentImageWhileLoading
    }

    /// Whether the options contains `.onlyLoadFirstFrame`.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `onlyLoadFirstFrame` instead.")
     var onlyLoadFirstFrame: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).onlyLoadFirstFrame
    }

    /// Whether the options contains `.cacheOriginalImage`.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `cacheOriginalImage` instead.")
     var cacheOriginalImage: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).cacheOriginalImage
    }

    /// The image which should be used when download image request fails.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `onFailureImage` instead.")
     var onFailureImage: Optional<CFCrossPlatformImage?> {
        return GHKingfisherParsedOptionsInfo(Array(self)).onFailureImage
    }

    /// Whether the `ImagePrefetcher` should load images to memory in an aggressive way or not.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `alsoPrefetchToMemory` instead.")
     var alsoPrefetchToMemory: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).alsoPrefetchToMemory
    }

    /// Whether the disk storage file loading should happen in a synchronous behavior or not.
    @available(*, deprecated,
    message: "Create a `GHKingfisherParsedOptionsInfo` from `GHKingfisherOptionsInfo` and use `loadDiskFileSynchronously` instead.")
     var loadDiskFileSynchronously: Bool {
        return GHKingfisherParsedOptionsInfo(Array(self)).loadDiskFileSynchronously
    }
}

/// The default modifier.
/// It does nothing and returns the image as is.
@available(*, deprecated, message: "Use `nil` in GHKingfisherOptionsInfo to indicate no modifier.")
