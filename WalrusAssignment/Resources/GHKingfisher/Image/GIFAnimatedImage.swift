...
/// Represents a set of image creating options used in GHKingfisher.
...
class GIFAnimatedImage {
    ...
    init?(from imageSource: CGImageSource, for info: [String: Any], options: ImageCreatingOptions) {
        ...
        for i in 0 ..< frameCount {
            ...
            images.append(GHKingfisherWrapper.image(cgImage: imageRef, scale: options.scale, refImage: nil))
