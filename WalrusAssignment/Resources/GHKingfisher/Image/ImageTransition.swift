...
/// extension API in GHKingfisher. You can assign an enum value with transition duration as
/// an item in `GHKingfisherOptionsInfo` to enable the animation transition.
///
