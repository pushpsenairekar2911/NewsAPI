     ...
     class Backend<T: DataTransformable> {
        ...
        /// - Throws: An error if the folder for storage cannot be got or created.
         init(config: Config) throws {
            ...
            let cacheName = "com.onevcat.GHKingfisher.ImageCache.\(config.name)"
        ...
        func prepareDirectory() throws {
            ...
            do {
                ...
                throw GHKingfisherError.cacheError(reason: .cannotCreateDirectory(path: path, error: error))
            }
        }
            ...
            expiration: StorageExpiration? = nil) throws
        {
            ...
            do {
                ...
                throw GHKingfisherError.cacheError(reason: .cannotConvertToData(object: value, error: error))
            }
            ...
            do {
                ...
                throw GHKingfisherError.cacheError(
            ...
            extendingExpiration: ExpirationExtending) throws -> T?
        {
            ...
            do {
                ...
                throw GHKingfisherError.cacheError(reason: .cannotLoadDataFromDisk(url: fileURL, error: error))
            }
        }
        ...
        func allFileURLs(for propertyKeys: [URLResourceKey]) throws -> [URL] {
            ...
            {
                throw GHKingfisherError.cacheError(reason: .fileEnumeratorCreationFailed(url: directoryURL))
            }

            guard let urls = directoryEnumerator.allObjects as? [URL] else {
                throw GHKingfisherError.cacheError(reason: .invalidFileEnumeratorContent(url: directoryURL))
            }
            return urls
        }
