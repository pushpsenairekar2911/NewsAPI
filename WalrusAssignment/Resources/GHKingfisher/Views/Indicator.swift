...
/// An indicator type which can be used to show the download task is in progress.
 protocol Indicator {
    ...
    /// Center offset of the indicator. GHKingfisher will use this value to determine the position of
...
final class ImageIndicator: Indicator {
    ...
    init?(
        ...
        options: GHKingfisherParsedOptionsInfo? = nil)
    {
        var options = options ?? GHKingfisherParsedOptionsInfo(nil)
