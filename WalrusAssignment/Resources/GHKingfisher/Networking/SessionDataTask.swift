...
@objc  class SessionDataTask: NSObject {
    ...
    struct TaskCallback {
        let onCompleted: Delegate<Result<ImageLoadingResult, GHKingfisherError>, Void>?
    ...
    let onTaskDone = Delegate<(Result<(Data, URLResponse?), GHKingfisherError>, [TaskCallback]), Void>()
